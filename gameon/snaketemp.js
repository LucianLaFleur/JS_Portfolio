...
// when the snake occupyies the same, area as the food, it eats it at the [coincidence]
  if(coincidence){
    //   add the eaten food to the loot list
    // galaxy brain solution for an earthly problem... [num1, num2, num3]
    // then for i in consumedFood array, drawImage(foodImg+'consumedFood[i]'...)
    // // push is important, not just contat for adding items to arrays
    // switch(spawnedFood){
    //     case foodImg1:
    //     consumedFood += '1';
...
//     consumedFood += spawnedFood;
//     for(let i=0; i < consumedFood.length; i++){
//         //         if(i==0){
//     console.log(`Consumed: ${consumedFood[i]}`)
// };
